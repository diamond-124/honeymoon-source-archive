...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var sketch:FlxSprite = new FlxSprite().loadGraphic(Paths.image("menu/menuthing"));
		sketch.frames = Paths.getSparrowAtlas('menu/menuthing');
		sketch.scrollFactor.set(0, 0);
		sketch.animation.addByPrefix('menumoving', "menumoving", 24);
		sketch.animation.play("menumoving");
		sketch.updateHitbox();
		sketch.screenCenter();
		...
		add(versionShit);
		var versionShit:FlxText = new FlxText(12, FlxG.height - 24, 0, "Friday Night Honeymoon V2 <3 - FNF v" + Application.current.meta.get('version'), 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
