function onTweenCompleted(teg)
	if teg=='bopP1' then --Bop BF Icon
		doTweenAngle('BoppinP1', 'iconP1', 0, 0.1);
	elseif teg=='bopP2' then --Bop Opponent Icon
		doTweenAngle('BoppinP2', 'iconP2', 0, 0.1);
	end
end

function onBeatHit()
	doTweenAngle('bopP1', 'iconP1', -5, 0.075); --Edit "0.075" to change how hard it bops
	doTweenAngle('bopP2', 'iconP2', 5, 0.075); --Edit "0.075" to change how hard it bops
end

function opponentNoteHit()
	setProperty('iconP2.y', getProperty('healthBar.y') - 66)
	doTweenY('singP2', 'iconP2', getProperty('healthBar.y') - 75, 0.075);

end

function goodNoteHit()
	setProperty('iconP1.y', getProperty('healthBar.y') - 66)
	doTweenY('singP1', 'iconP1', getProperty('healthBar.y') - 75, 0.075);
