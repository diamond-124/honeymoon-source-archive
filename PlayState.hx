...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['what song are you playing??', 0.2], //From 0% to 19%
		['Oh wow', 0.4], //From 20% to 39%
		['You Can DO It!', 0.5], //From 40% to 49%
		['Keep Going!', 0.6], //From 50% to 59%
		['Good Job!', 0.69], //From 60% to 68%
		['the heck', 0.7], //69%
		['huh?', 0.8], //From 70% to 79%
